...
@dataclass
class CIFARFewShotALTDataArgs(CIFARDataArgs):
...
class CIFARFewShotALTDM(CIFAR100DataModule):
    """class which iplements zero-shot cifar"""

    def __init__(self, args: CIFARFewShotALTDataArgs, *margs, **kwargs):
