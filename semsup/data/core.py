...
class SemSupDataArgs:
    ...
    def __post_init__(self):
        print("train_label: {}".format(self.train_label_json))
        print("train_path: {}".format(Path(self.train_label_json).absolute()))
        print("cache_dir: {}".format(self.cache_dir))
...
class SemSupDataModule(pl.LightningDataModule):
    ...
    def _setup_label_dataset(self, dataset, classlabel):
        ...
        dataset.map(lambda x, i: label_to_idx[x["label"]].append(i), with_indices=True, load_from_cache_file=False)
